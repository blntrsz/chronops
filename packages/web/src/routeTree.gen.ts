...
const OrgSlugAssessmentQuestionerRouteRoute = OrgSlugAssessmentQuestionerRouteRouteImport.update({
  id: "/questioner",
  path: "/questioner",
  getParentRoute: () => OrgSlugAssessmentRouteRoute,
} as any);
const OrgSlugAssessmentQuestionerIdRoute = OrgSlugAssessmentQuestionerIdRouteImport.update({
  id: "/$id",
  path: "/$id",
...
const OrgSlugAssessmentQuestionerInstanceRouteRouteChildren: OrgSlugAssessmentQuestionerInstanceRouteRouteChildren =
  {
    OrgSlugAssessmentQuestionerInstanceIdRoute: OrgSlugAssessmentQuestionerInstanceIdRoute,
  };
...
const OrgSlugAssessmentRouteRouteChildren: OrgSlugAssessmentRouteRouteChildren = {
  OrgSlugAssessmentQuestionerRouteRoute: OrgSlugAssessmentQuestionerRouteRouteWithChildren,
...
const OrgSlugAuditRouteRouteWithChildren = OrgSlugAuditRouteRoute._addFileChildren(
  OrgSlugAuditRouteRouteChildren,
);
...
const OrgSlugEvidenceRouteRouteWithChildren = OrgSlugEvidenceRouteRoute._addFileChildren(
  OrgSlugEvidenceRouteRouteChildren,
);
...
const OrgSlugRiskRouteRouteWithChildren = OrgSlugRiskRouteRoute._addFileChildren(
  OrgSlugRiskRouteRouteChildren,
);
