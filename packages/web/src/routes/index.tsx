        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-lg text-slate-300">
              Streamline frameworks, controls, and evidence management. Stay audit-ready with a clean workflow.
            </p>

            <div className="mt-8 space-y-4">
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 flex-shrink-0 text-cyan-400" />
                <span className="text-slate-300">Framework mapping & control libraries</span>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 flex-shrink-0 text-cyan-400" />
                <span className="text-slate-300">Evidence collection + doc tracking</span>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 flex-shrink-0 text-cyan-400" />
                <span className="text-slate-300">Real-time compliance posture</span>
              </div>
            </div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Button asChild size="lg" variant="outline" className="text-slate-300">
          ...
          <Card className="ds-glass rounded-xl">
            <CardHeader>
              <CardTitle className="text-white">Built for audit-ready teams</CardTitle>
          ...
          {[
            {
              icon: Zap,
              title: 'Fast Setup',
              description: 'Set up in minutes, not hours. Start with templates and grow from there.',
            },
            {
              icon: Lock,
            ...
            <Card key={feature.title} className="border-slate-700/50 bg-slate-800/30 backdrop-blur-sm">
              <CardHeader>
