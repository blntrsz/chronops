        ...
        <Card className="ds-glass">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-slate-400">
              Sent to <span className="font-medium text-slate-300">{maskedEmail}</span>
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={onVerify} className="space-y-4">
              <div className="flex justify-center">
                <InputOTP maxLength={6} value={otp} onChange={setOtp} pattern="\\d*">
                  <InputOTPGroup>
              ...
              <div className="flex items-center justify-between text-sm">
                <Button type="button" variant="link" className="px-0 text-slate-300" asChild>
                  <Link to="/login">Change email</Link>
                </Button>
                <Button type="button" variant="link" className="px-0 text-slate-300" onClick={onResend} disabled={isLoading}>
                  Resend
                </Button>
              </div>
            </form>
